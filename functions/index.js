...
function followUsHtml() {
  return `<div style="margin-top:1.5rem;background:#fdf0f1;border:1px solid #e8c9cd;border-radius:8px;padding:1rem 1.25rem;text-align:center;">
    <p style="margin:0 0 0.6rem;font-weight:700;color:#5D1725;">Follow the Admirals</p>
    <div style="display:flex;gap:1.25rem;justify-content:center;align-items:center;">
      <a href="https://www.facebook.com/profile.php?id=61560811620518" target="_blank" rel="noopener noreferrer" style="display:flex;align-items:center;gap:0.4rem;color:#5D1725;font-weight:600;text-decoration:none;font-size:0.9rem;">
      ...
      <a href="https://www.instagram.com/fhsadmiralshockey/" target="_blank" rel="noopener noreferrer" style="display:flex;align-items:center;gap:0.4rem;color:#5D1725;font-weight:600;text-decoration:none;font-size:0.9rem;">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c2.72 0 3.06.01 4.12.06 1.06.05 1.79.22 2.42.46.66.26 1.22.6 1.77 1.15.55.55.9 1.11 1.15 1.77.24.63.41 1.36.46 2.42C21.98 8.94 22 9.28 22 12s-.01 3.06-.06 4.12c-.05 1.06-.22 1.79-.46 2.42-.26.66-.6 1.22-1.15 1.77-.55.55-1.11.9-1.77 1.15-.63.24-1.36.41-2.42.46C15.06 21.99 14.72 22 12 22s-3.06-.01-4.12-.06c-1.06-.05-1.79-.22-2.42-.46-.66-.26-1.22-.6-1.77-1.15-.55-.55-.9-1.11-1.15-1.77-.24-.63-.41-1.36-.46-2.42C2.02 15.06 2 14.72 2 12s.01-3.06.06-4.12c.05-1.06.22-1.79.46-2.42.26-.66.6-1.22 1.15-1.77.55-.55 1.11-.9 1.77-1.15.63-.24 1.36-.41 2.42-.46C8.94 2.02 9.28 2 12 2zm0 1.8c-2.67 0-2.99.01-4.04.06-.87.04-1.34.18-1.65.3-.42.16-.72.36-1.03.67-.31.31-.51.61-.67 1.03-.12.31-.26.78-.3 1.65C4.26 8.51 4.25 8.83 4.25 11.5v1c0 2.67.01 2.99.06 4.04.04.87.18 1.34.3 1.65.16.42.36.72.67 1.03.31.31.61.51 1.03.67.31.12.78.26 1.65.3 1.05.05 1.37.06 4.04.06s2.99-.01 4.04-.06c.87-.04 1.34-.18 1.65-.3.42-.16.72-.36 1.03-.67.31-.31.51-.61.67-1.03.12-.31.26-.78.3-1.65.05-1.05.06-1.37.06-4.04v-1c0-2.67-.01-2.99-.06-4.04-.04-.87-.18-1.34-.3-1.65a2.79 2.79 0 00-.67-1.03 2.79 2.79 0 00-1.03-.67c-.31-.12-.78-.26-1.65-.3C14.99 3.81 14.67 3.8 12 3.8zm0 3.05a5.15 5.15 0 110 10.3 5.15 5.15 0 010-10.3zm0 1.8a3.35 3.35 0 100 6.7 3.35 3.35 0 000-6.7zm5.35-1.99a1.2 1.2 0 11-2.4 0 1.2 1.2 0 012.4 0z"/></svg>
        Instagram
      </a>
    </div>
  </div>`;
